...
- Pkg folder: [packages\rbac-user-roles](https://github.com/blackcatacademy/blackcat-database/blob/main/packages\rbac-user-roles)
...
- Outbound (depends on): "rbac_roles", "tenants", "users"
...
| Engine | Support |
| --- | --- |
| mysql | ✅ schema(6)<br/>✅ views(3)<br/>⚠️ seeds |
...
## Usage
- Install/upgrade schema: pwsh -NoLogo -NoProfile -File scripts/schema-tools/Migrate-DryRun.ps1 -Package rbac-user-roles -Apply
