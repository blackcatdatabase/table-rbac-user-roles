...
final class RbacUserRolesModule implements ModuleInterface
{
    public function name(): string { return 'table-rbac_user_roles'; }
    public function table(): string { return 'rbac_user_roles'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-rbac_roles', 'table-tenants', 'table-users' ]; }

    public static function contractView(): string { return 'vw_rbac_user_roles'; }
...
SQL;
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_rbac_user_roles_role', 'idx_rbac_user_roles_tenant', 'idx_rbac_user_roles_user' ];
        if ($d->isMysql()) {
        ...
        $expectedFk  = [ 'fk_rbac_ur_grant', 'fk_rbac_ur_role', 'fk_rbac_ur_tenant', 'fk_rbac_ur_user' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_rbac_user_roles_role', 'idx_rbac_user_roles_tenant', 'idx_rbac_user_roles_user' ],
            'foreignKeys' => [ 'fk_rbac_ur_grant', 'fk_rbac_ur_role', 'fk_rbac_ur_tenant', 'fk_rbac_ur_user' ],
        ];
    }
}
