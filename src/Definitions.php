...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'rbac_user_roles'; }
    public static function contractView(): string { return 'vw_rbac_user_roles'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'user_id', 'role_id', 'tenant_id', 'scope', 'status', 'granted_by', 'granted_at', 'expires_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'user_id', 'role_id', 'tenant_id', 'scope' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'user_id', 'role_id', 'tenant_id', 'granted_by' ]; }
