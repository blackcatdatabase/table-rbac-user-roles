...
namespace BlackCat\Database\Packages\RbacUserRoles;
...
use BlackCat\Database\Packages\RbacUserRoles\Repository\RbacUserRoleRepository as GeneratedRepository;
...
{
  private RbacUserRoleRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof RbacUserRoleRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected RbacUserRoleRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserRoles\Dto\RbacUserRoleDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\RbacUserRoles\Dto\RbacUserRoleDto|null { return $this->repo->getById($id, $asDto); }
