...
namespace BlackCat\Database\Packages\RbacUserRoles\Mapper;

use BlackCat\Database\Packages\RbacUserRoles\Dto\RbacUserRoleDto;
use BlackCat\Database\Packages\RbacUserRoles\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO RbacUserRoleDto:
...
final class RbacUserRoleDtoMapper
{
    ...
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'user_id', 'role_id', 'tenant_id', 'granted_by' ];
    /** @var string[] */
     ...
     * @return RbacUserRoleDto
     */
    public static function fromRow(array $row): RbacUserRoleDto
    {
        /** @var RbacUserRoleDto */
        return DtoHydrator::fromRow(
            RbacUserRoleDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?RbacUserRoleDto
    {
     ...
     *
     * @param RbacUserRoleDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(RbacUserRoleDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(RbacUserRoleDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(RbacUserRoleDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,RbacUserRoleDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,RbacUserRoleDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(RbacUserRoleDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,RbacUserRoleDto>
     */
